class ApprovedFarms {
  ...
  String stationId;
  Location location;
  List<PolygonLocation> polygonalLocation;
  int area;
  Null areaUnit;
  Null cropType;
  Null soilType;
  ...
  ApprovedFarms.fromJson(Map<String, dynamic> json) {
    farmId = json['farmId'];
    ...
    if (json['polygonalLocation'] != null) {
      polygonalLocation = new List<PolygonLocation>();
      json['polygonalLocation'].forEach((v) {
        polygonalLocation.add(new PolygonLocation.fromJson(v)); 
      });
    }
    area = json['area'];
...
class PolygonLocation {
  ...
  PolygonLocation({this.lat, this.log});

  PolygonLocation.fromJson(Map<String, dynamic> json) {
    lat = json['lat'];
    log = json['log'];
  }
